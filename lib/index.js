    ...
    return (
      <View style={[styles.container, this.props.style]}>
        <TouchableOpacity
          ...
          disabled={disabled}
          style={this.props.flagContainerStyle}
        >
          <Image
            ...
            onPress={this.onPressFlag}
          />
          <Text style={this.props.flagDialCodeStyle}>
            {`+${PhoneNumber.getCountryDataByCode(iso2).dialCode}`}
          </Text>
        </TouchableOpacity>
        ...
        <CountryPicker
          ...
          buttonConfirmStyle={this.props.buttonConfirmStyle}
          buttonCancelStyle={this.props.buttonCancelStyle}
...
PhoneInput.propTypes = {
  ...
  flagContainerStyle: styleType,
  flagDialCodeStyle: styleType,
  buttonConfirmStyle: styleType,
  buttonCancelStyle: styleType,
  buttonTextStyle: styleType,
  buttonViewStyle: styleType
};
