    ...
    return (
      ...
      >
        <View style={styles.basicContainer}>
          ...
          >
            <View style={[styles.buttonView, this.props.buttonViewStyle]}>
              <TouchableOpacity onPress={this.onPressCancel} style={this.props.buttonCancelStyle}>
                <Text style={[{ color: buttonColor }, this.props.buttonTextStyle]}>
                  {this.props.cancelText || 'Cancel'}
                </Text>
              </TouchableOpacity>

              <TouchableOpacity onPress={this.onPressSubmit} style={this.props.buttonConfirmStyle}>
                <Text style={[{ color: buttonColor }, this.props.buttonTextStyle]}>
